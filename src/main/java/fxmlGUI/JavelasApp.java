...
public class JavelasApp extends Application {
	...
	public void showMainMenu() {   
		try {
			...
			loader.setLocation(JavelasApp.class.getResource("/fxmlGUI/MainMenu.fxml"));
	...
	public void showMistakeMenu(String text) {
		try {
			FXMLLoader loader = new FXMLLoader();
			loader.setLocation(JavelasApp.class.getResource("/fxmlGUI/MistakeMenu.fxml"));
			root = (BorderPane) loader.load();
	...
	public void showThankYou() {
		try {
			FXMLLoader loader = new FXMLLoader();
			loader.setLocation(JavelasApp.class.getResource("/fxmlGUI/Thankyou.fxml"));
			root = (BorderPane) loader.load();
